...
const supplierStatsRoutes = require('./routes/supplierStatsRoutes')
const companyCostRoutes = require('./routes/companyCostRoutes')
...
app.use('/api/supplier-payment-schedules', supplierPaymentScheduleRoutes)
app.use('/api/delivery-orders', deliveryOrderRoutes)
app.use('/api/supplier-invoices', supplierInvoiceRoutes)
app.use('/api/supplier-returns', supplierReturnRoutes)
app.use('/api/supplier-stats', supplierStatsRoutes)
app.use('/api/company-costs', companyCostRoutes)
